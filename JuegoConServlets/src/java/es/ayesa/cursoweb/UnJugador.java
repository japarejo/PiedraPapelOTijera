...
public class UnJugador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Jugador humano: "+ jugador+"</h1>");
            out.println("<h1>Jugada humano: "+ jugada+"</h1>");
            out.println("<h1>Jugador maquina: "+ nombreMaquina+"</h1>");
            out.println("<h1>Jugada maquina: "+ jugadaMaquina+"</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
